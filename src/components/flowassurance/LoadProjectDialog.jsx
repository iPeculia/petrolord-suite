        ...
        return (
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle>Load Flow Assurance Project</DialogTitle>
                        <DialogDescription>Select a previously saved project to load its data.</DialogDescription>
                    </DialogHeader>
                            ...
                            projects.map(project => (
                                <div key={project.id}
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Folder className="h-5 w-5 text-lime-400" />
                                        <div>
