...
const EmptyState = ({ onGenerate }) => {
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-white mb-2">Petrophysics Estimator</h2>
      <p className="text-lime-200 max-w-md mb-6">
        Upload a LAS file and define your models to calculate Vshale, porosity, and water saturation.
      </p>
