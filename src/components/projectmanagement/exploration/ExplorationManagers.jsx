                        ...
                        <TableRow key={idx} className="border-b-slate-800">
                            ...
                            <TableCell>
                                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                                    <div className="h-full bg-blue-500" style={{ width: `${stage.progress}%` }} />
                                </div>
                            </TableCell>
                            <TableCell>
                                <Badge variant="outline" className={stage.progress === 100 ? "text-green-400 border-green-500/50" : stage.progress > 0 ? "text-blue-400 border-blue-500/50" : "text-slate-500 border-slate-600"}>
                    ...
                    {gates.length > 0 ? gates.map((gate, idx) => (
                        <TableRow key={idx} className="border-b-slate-800">
                            ...
                            <TableCell className="text-right">
                                <Button size="sm" variant="ghost" className="h-7 text-xs text-blue-400 hover:text-white">Review Criteria</Button>
                            </TableCell>
                        </TableRow>
