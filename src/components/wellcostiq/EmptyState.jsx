...
const EmptyState = () => {
  return (
    <motion.div
      ...
      className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 h-full flex items-center justify-center"
    >
      <div className="text-center py-12">
        <ClipboardPen className="w-16 h-16 text-cyan-400 mx-auto mb-4" />
        <h2 className="text-2xl font-bold text-white mb-4">WellCost IQ</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-8">
          ...
          <div className="bg-white/5 rounded-lg p-4">
            ...
            <p className="text-lime-300 text-sm">Enter cost parameters or get AI suggestions.</p>
          </div>
          <div className="bg-white/5 rounded-lg p-4">
        ...
        <div className="mt-8 p-4 bg-gradient-to-r from-teal-500/10 to-cyan-500/10 rounded-lg border border-cyan-500/20">
          <h3 className="text-lg font-semibold text-white mb-3">AI-Powered Backend</h3>
          <p className="text-lime-200 text-sm max-w-3xl mx-auto">
            The "Get Suggestions" feature simulates communication with a dedicated backend service. This service analyzes a database of historical project data to provide relevant, market-based estimates for rig rates, service spreads, and drilling durations, helping you create more accurate forecasts.
          </p>
        </div>
      </div>
    </motion.div>
