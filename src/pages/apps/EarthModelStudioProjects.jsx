import React, { useState, useEffect } from 'react';
    ...
    import { Plus, Folder, Trash2, Loader2, Check, ChevronsUpDown, Search } from 'lucide-react';
    ...
    const EarthModelStudioProjects = () => {
      const { user } = useAuth();
      ...
      const handleDeleteProject = async () => {
        ...
        try {
          ...
          toast({ title: `Project "${projectToDelete.name}" deleted successfully.` });
        } catch (error) {
          toast({
      ...
      return (
        <>
          <Helmet>
            <title>EarthModel Studio Projects</title>
          ...
          <div className="container mx-auto p-4 sm:p-6 md:p-8">
            ...
            >
              <h1 className="text-4xl font-bold text-white">EarthModel Studio Projects</h1>
                          ...
                          <AlertDialogContent className="bg-slate-900 border-slate-700 text-white">
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This action cannot be undone. This will permanently delete the project "{project.name}" and all its associated data.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
    ...
    export default EarthModelStudioProjects;