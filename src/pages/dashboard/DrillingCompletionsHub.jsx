  ...
  return (
    <div className="p-6 space-y-6 min-h-screen bg-slate-950 text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white">Drilling & Completions Hub</h1>
          <p className="text-slate-400 mt-2">Complete suite for well lifecycle: planning, drilling, completion, and intervention.</p>
        </div>
