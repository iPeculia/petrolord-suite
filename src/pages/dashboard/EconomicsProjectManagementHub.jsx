    ...
    <div className="p-6 space-y-6 min-h-screen bg-slate-950 text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-400 mt-2">Integrated hub for financial modeling, project execution, risk, and compliance.</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-slate-900/50 p-4 rounded-xl border border-slate-800">
        <div className="w-full md:w-96 relative">
          ...
          <Input 
            ...
            className="pl-10 bg-slate-950 border-slate-800 text-white focus:ring-indigo-500/50"
            value={searchTerm}
