...
const ProductionAndOptimization = () => {
  ...
  useEffect(() => {
    console.log(`Rendering [ProductionAndOptimization] with ${apps?.length || 0} apps from master_apps`);
  }, [apps]);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-400 mt-2">
            Monitor production performance, optimize well output, and manage field operations.
          </p>
        </div>
...
export default ProductionAndOptimization;
